...
Despite getting rid of the extreme outliers, there is still presence of a few on the right. As other variables before, even this this variable is not normally distributed and is skewed towards the right which will impact prediction accuracy. 
